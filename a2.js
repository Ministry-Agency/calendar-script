    ...
    loadGlobalSettings() {
        try {
            ...
            if (!window.calendarSettings) {
                console.warn('[UnifiedCalendarManager] Объект window.calendarSettings не найден, используем настройки по умолчанию');
            ...
            if (window.calendarSettings.load.globalSettings) {
                ...
                // Проверяем, существует ли объект window.calendarSettings.settings
