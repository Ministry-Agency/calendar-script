        ...
        try {
            ...
            if (applyButton) {
                applyButton.addEventListener('click', () => {
                    ...
                    if (blockButton && blockButton.classList.contains('is--add-service')) {
                        ...
                        // Иначе применяем скидку
                        this.applyDiscountToRange();
                    }
                });
            }
            
            // Отдельный обработчик для кнопки применения скидки
            const applyDiscountButton = document.querySelector('[button_apply_discount]');
            if (applyDiscountButton) {
                applyDiscountButton.addEventListener('click', () => this.applyDiscountToRange());
            }
            ...
            if (blockButton) {
                blockButton.addEventListener('click', () => {
                    ...
                    // Если кнопка активна, готовимся к блокировке
